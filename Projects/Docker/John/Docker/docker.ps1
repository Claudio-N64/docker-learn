...
az acr login --name nascloudacr

docker tag badfather nascloudacr.azurecr.io/images/badfather
docker push nascloudacr.azurecr.io/images/badfather
docker pull nascloudacr.azurecr.io/images/badfather
docker image history nascloudacr.azurecr.io/images/badfather

#Cleanup
docker rmi nascloudacr.azurecr.io/images/badfather
docker rmi badfather
docker rmi httpd

#talk to running ACI instance
az container list --output table
az container start --name amazing-brattain --resource-group Containers
az container exec -g Containers --name amazing-brattain --container-name amazing-brattain --exec-command "/bin/bash"
az container stop --name amazing-brattain --resource-group Containers
